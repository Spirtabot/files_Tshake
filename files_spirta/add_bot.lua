...
if (text and text == "تفعيل" and is_sudo(msg) and database:get("spirta:get_back_add_bot:"..bot_id)) then 
if database:get("spirta:link:auto:launch"..bot_id) then 
database:set("lock_link:spirta"..msg.chat_id_..bot_id,"ok")
database:set("lock_inline:spirta"..msg.chat_id_..bot_id,"ok")
end 
if database:get("spirta:fwd:auto:launch"..bot_id) then 
database:set("lock_fwd:spirta"..msg.chat_id_..bot_id,"ok")
end 
if database:get("spirta:medea:auto:launch"..bot_id) then 
...
if database:get("spirta:username:auto:launch"..bot_id) then 
database:set("lock_username:spirta"..msg.chat_id_..bot_id,"ok")
end 
if database:get("spirta:spam:auto:launch"..bot_id) then 
database:set("lock_lllll:spirta"..msg.chat_id_..bot_id,"ok")
end 

if database:get("spirta:auto:seva:admin:auto:launch"..bot_id) then 
local function cb2(extra,result,success)
for k,v in pairs(result.members_) do
database:sadd('spirta:'..bot_id..'mods:'..msg.chat_id_, v.user_id_)
end
end
...
database:sadd('spirta:'..bot_id..'creator:'..msg.chat_id_, v.user_id_)
end
end
end
...
if u then 
database:set("spirta:"..u..":auto:launch"..bot_id,"ok")
send(msg.chat_id_, msg.id_, 1, "✔┇تم الحفظ ", 1, 'html')
elseif a then 
database:del("spirta:"..a..":auto:launch"..bot_id)
send(msg.chat_id_, msg.id_, 1, "✔┇تم الحفظ ", 1, 'html')
end
...
database:set("spirta:get_back_add_bot:"..bot_id,"ok")
end 
...
database:del("spirta:get_back_add_bot:"..bot_id)
end 
